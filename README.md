...
- Splash Screen : A Splash Screen is a screen that appears when we open an app on our mobile device. Sometimes it's referred to as a launch screen or startup screen and shows up when our app is loading after we've just opened it. We just used a GDSC Nit Hamirpur logo in our app splash screen.

- SEARCH Screen : User can search our task by task title in our app.

- Update and delete : User can delete and update his task, He just need to swipe left & right for it. We used swipe functionality for it.
